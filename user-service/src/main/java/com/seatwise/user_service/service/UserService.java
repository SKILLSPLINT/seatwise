...
public interface UserService {
    ...
    UserResponse getUserProfile(String userEmail, String userTimeZone);
    UserResponse registerAdmin(AdminRegisterRequest request, String userTimeZone);
    UserResponse uploadProfilePicture(String userEmail, MultipartFile profilePicture, String userTimeZone);
}
